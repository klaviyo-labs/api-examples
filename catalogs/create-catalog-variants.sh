# sample cURL request to the Bulk Create Catalog Variants endpoint. This code is used in the Set up a custom catalog in Klaviyo YouTube video: https://www.youtube.com/watch?v=GL6pWtE-LBM&list=PLHkNfHgtxcUanrkMnKPdkRzuWU7MGv_xM&index=10
curl --request POST \
